#include <SimilarityByWassersteinDistance.h>

ttk::SimilarityByWassersteinDistance::SimilarityByWassersteinDistance() {
  this->setDebugMsgPrefix("SimilarityByWassersteinDistance");
}

int ttk::SimilarityByWassersteinDistance::execute() {
  ttk::Timer t;
...
int ttk::SimilarityByWassersteinDistance::performSingleMatching(
  int i,
...
int ttk::SimilarityByWassersteinDistance::performMatchings(
  int numInputs,
  std::vector<ttk::DiagramType> &inputPersistenceDiagrams,
  std::vector<std::vector<MatchingType>> &outputMatchings,
  const std::string &algorithm,
...
int ttk::SimilarityByWassersteinDistance::performTracking(
...
int ttk::SimilarityByWassersteinDistance::performPostProcess(
