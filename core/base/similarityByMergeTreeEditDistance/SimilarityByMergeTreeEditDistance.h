...
///
/// \ingroup base
/// \class ttk::SimilarityByMergeTreeEditDistance
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// This module defines the %SimilarityByMergeTreeEditDistance class that computes for
/// each vertex of a triangulation the average scalar value of itself and its
/// direct neighbors.
///
/// \b Related \b publication: \n
/// 'SimilarityByMergeTreeEditDistance'
...
namespace ttk {
  ...
  class SimilarityByMergeTreeEditDistance : virtual public Debug {

  public:
    SimilarityByMergeTreeEditDistance() {
      this->setDebugMsgPrefix("SimilarityByMergeTreeEditDistance");
    };
    ~SimilarityByMergeTreeEditDistance(){};
