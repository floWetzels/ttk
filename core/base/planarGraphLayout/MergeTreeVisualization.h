...
namespace ttk {
  ...
  protected:
    ...
    double conflictTolerance_ = 1e-6;
  ...
  public:
    ...
    void setConflictTolerance(double conflictTolerance) {
      conflictTolerance_ = conflictTolerance;
    }
    ...
    bool isConflictingBoundsXOneWay(
      ...
      return (std::get<0>(first) <= std::get<0>(second) + conflictTolerance_
              and std::get<0>(second)
                    <= std::get<1>(first) + conflictTolerance_)
             or (std::get<0>(first) <= std::get<1>(second) + conflictTolerance_
                 and std::get<1>(second)
                       <= std::get<1>(first) + conflictTolerance_);
    }
    ...
    bool isConflictingBoundsYOneWay(
      std::tuple<float, float, float, float> first,
      std::tuple<float, float, float, float> second) {
      return (std::get<2>(first) <= std::get<2>(second) + conflictTolerance_
              and std::get<2>(second)
                    <= std::get<3>(first) + conflictTolerance_)
             or (std::get<2>(first) <= std::get<3>(second) + conflictTolerance_
                 and std::get<3>(second)
                       <= std::get<3>(first) + conflictTolerance_);
    }
